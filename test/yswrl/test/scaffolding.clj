...
(defn create-swirl [type authorId title review recipientNames optional-values]
  (let [swirl (swirls-repo/save-draft-swirl type authorId title review nil optional-values)]
